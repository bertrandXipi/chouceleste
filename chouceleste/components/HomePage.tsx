                ...
                <div className="bg-white p-6 shadow-lg rounded-lg flex-1 flex flex-col justify-center items-center text-center">
                    <div className="grid grid-cols-3 gap-4 w-full">
                        <a href="#" className="block p-2 rounded-lg hover:bg-gray-50 transition-colors">
                            <ChronoFreshIcon />
                            <span className="font-semibold text-sm">Livraison Chronofresh</span>
                        </a>
                        <a href="#" className="block p-2 rounded-lg hover:bg-gray-50 transition-colors">
                            <ClickCollectIcon />
                        ...
                        <a href="#" className="block p-2 rounded-lg hover:bg-gray-50 transition-colors">
                           <ChronoPostIcon />
                            <span className="font-semibold text-sm">Livraison Domicile</span>
                        </a>
                    </div>
                    <p className="mt-4 text-sm text-gray-600">Livraison France & Monaco offerte dès 70€ d'achats</p>
                </div>
                 <div className="bg-white p-6 shadow-lg rounded-lg flex-1 flex flex-col justify-center text-center">
                    <h3 className="font-serif text-2xl font-bold mb-2 tracking-tighter">Newsletter</h3>
                    <p className="mb-4 text-gray-600 text-sm">Restez informé de nos dernières créations gourmandes.</p>
                    <form className="flex">
                        <input type="email" placeholder="votre@email.com" className="w-full px-4 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-[#E4002B]" />
                        <button type="submit" className="bg-[#E4002B] text-white px-6 py-2 rounded-r-md font-semibold hover:bg-[#c30024] transition-colors">OK</button>
                    </form>
                </div>
            </div>
            <div className="lg:col-span-7 grid grid-cols-2 gap-6">
                 <div className="col-span-2 sm:col-span-1 bg-cover bg-center rounded-lg shadow-lg group relative overflow-hidden min-h-[300px]" style={{ backgroundImage: 'url(https://picsum.photos/id/305/600/700)' }}>
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <a href="#" className="text-white font-serif text-3xl font-bold transform transition-transform group-hover:-translate-y-1 tracking-tighter">Les Choux Signature</a>
                    </div>
                </div>
                <div className="col-span-2 sm:col-span-1 grid grid-rows-2 gap-6">
                     <div className="bg-cover bg-center rounded-lg shadow-lg group relative overflow-hidden" style={{ backgroundImage: 'url(https://picsum.photos/id/431/500/400)' }}>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4">
                            <a href="#" className="text-white font-serif text-2xl font-bold transform transition-transform group-hover:-translate-y-1 tracking-tighter">Nos Coffrets</a>
                        </div>
                    </div>
                    <div className="bg-cover bg-center rounded-lg shadow-lg group relative overflow-hidden" style={{ backgroundImage: 'url(https://picsum.photos/id/225/500/400)' }}>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4">
                            <a href="#" className="text-white font-serif text-2xl font-bold transform transition-transform group-hover:-translate-y-1 tracking-tighter">Sur-Mesure</a>
                        </div>
                    </div>
                </div>
            </div>
...
const FeaturedProducts: React.FC = () => (
    <section className="py-16">
        <div className="container mx-auto px-4">
            <h2 className="font-serif text-4xl font-bold text-center mb-10 tracking-tighter">Nos Incontournables</h2>
...
const NewsSection: React.FC = () => (
    <section className="bg-white py-16">
        <div className="container mx-auto px-4">
            <h2 className="font-serif text-4xl font-bold text-center mb-10 tracking-tighter">Nos Actualités</h2>
                ...
                {newsArticles.map((article) => (
                    <div key={article.id} className="group">
                        ...
                        <div className="p-4">
                            ...
                            <a href="#" className="font-bold text-[#3A3A3A] hover:underline">Lire plus →</a>
                        </div>
                    </div>
                ))}
            </div>
    ...
    <section className="container mx-auto px-4 py-16">
        <div className="flex flex-col md:flex-row items-center gap-12 bg-white p-12 rounded-lg shadow-lg">
            ...
            <div className="md:w-1/2 text-center md:text-left">
                <h3 className="font-serif text-4xl font-bold text-[#3A3A3A] mb-4 tracking-tighter">La Quintessence du Goût</h3>
                <p className="text-lg text-gray-700 leading-relaxed">
                    Le Chou Céleste est le fruit d'une passion pour l'excellence. Chaque création est un hommage à la pâtisserie française, un mélange subtil de textures et de saveurs, élaboré à partir d'ingrédients d'exception rigoureusement sélectionnés.
                </p>
            </div>
        </div>
    </section>
